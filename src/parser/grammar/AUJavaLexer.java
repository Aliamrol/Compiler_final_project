...
public class AUJavaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"INT", "BOOLEAN", "IF", "ELSE", "WHILE", "CONTINUE", "BREAK", "NEW", 
			"THIS", "PRINTLN", "TRUE", "FALSE", "ASSIGN", "PLUS", "MINUS", "MULT", 
			"DIV", "EQ", "NEQ", "LT", "GT", "LTE", "GTE", "AND", "OR", "NOT", "LPAREN", 
			"RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", "SEMI", "COMMA", "DOT", 
			"ID", "INT_LITERAL", "WS", "LINE_COMMENT", "BLOCK_COMMENT"
		};
	}
